...
module.exports = require('./MapStore2/build/buildConfig')({
    bundles: {
        'geoclima': path.join(__dirname, "js", "app"),
        'geoclima-embedded': path.join(__dirname, "js", "embedded"),
        'geoclima-api': path.join(__dirname, "MapStore2", "web", "client", "product", "api"),
